      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">Transform your learning with AI-powered study tools</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <BookOpen className="h-6 w-6 text-pulse-500" />
                  </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <FileText className="h-6 w-6 text-pulse-500" />
                  </div>
                  <div className="ml-5 w-0 flex-1">
                    <dl>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <Users className="h-6 w-6 text-pulse-500" />
                  </div>
                  <div className="ml-5 w-0 flex-1">
                    <dl>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-2 max-w-xl text-sm text-gray-500">
                <p>Welcome to StudyAIde! Here's how to get started with your AI-powered learning journey.</p>
              </div>
              <div className="mt-5">
